...
"the compass points east": "เข็มทิศชี้ไปทางทิศตะวันออก",
 ...
 "a masked soldier rounds the corner, gun drawn": "ทหารใต้หน้ากากปรากฏตัวขึ้นกลางแยกพร้อมปืนชี้มาตรงหน้า", 
 ...
 "a safe place in the wilds.": "ที่หลบภัยกลางป่า", "fur": "ขนสัตว์",
 ...
 "willing to talk about it, for a price.": "ยินดีที่จะพูดคุยเรื่องดังกล่าว ด้วยราคาที่สมเหตุสมผล",
 "a beast, wilder than imagining, erupts out of the foliage": "สัตว์อสูรหน้าตาผิดเพี้ยนเกินจินตนาการกระโจนตัวออกมาจากพุ่มไม้",
 ...
 "a ragged stranger stumbles through the door and collapses in the corner": "คนแปลกหน้าสวมผ้าคลุมเก่า ๆ เดินเข้ามาทางประตูและล้มลงตรงมุมห้อง", 
 ...
 "perks:": "ความสามารถพิเศษ:", "the torch goes out": "คบไฟมอดลง", "saved.": "บันทึกเสร็จสิ้น",
 ...
 "someone throws a stone.": "มีใครบางคนปาก้อนหินมา",
 ...
 "punch": "ต่อย", "water": "น้ำ", "desert rat": "ชาวทะเลทราย", "explore": "สำรวจ",
 ...
 "builder says she could make finer things, if she had the tools": "ผู้สร้างบอกว่าเธอสามารถสร้างของที่ประณีตกว่านี้ก็ได้ ถ้าหากเธอมีอุปกรณ์ครบ",
 "soldier": "ทหาร", "learn scouting": "เรียนรู้ทักษะการสำรวจ", "share.": "share.", "choose one slot to save to": "เลือกช่องที่ต้องการบันทึก.",
 ...
 "the clinic has been ransacked.": "คลินิกถูกรื้อค้นจนทั่ว", "drop:": "สิ่งที่ตก:",
 ...
 "a youth lashes out with a tree branch.": "เด็กหนุ่มคนหนึ่งกระโจนออกมาพร้อมกิ่งไม้",
 ...
 "a sick man hobbles up": "ชายท่าทางป่วยกะเผลกเข้ามา", "An&nbsp;Abandoned&nbsp;Town": "เมืองร้าง", "cart": "รถเข็น",
 "might be things worth having still inside.": "อาจจะยังมีของมีค่าอยู่ข้างใน", "the wood has run out": "ฟืนเริ่มเหลือน้อยเต็มที",
 ...
 "a beast charges out of a ransacked classroom.": "สัตว์ป่ากระโจนออกมาจากห้องเรียน",
 ...
 "a stranger arrives in the night": "คนแปลกหน้าเข้ามาอาศัยในเวลาค่ำ", "hut": "กระท่อม", "trapper": "ผู้ติดตั้งกับดัััก", "a battered highway sign stands guard at the entrance to this once-great city.": "ป้ายบอกทางตั้งตระหง่านอยู่หน้าเมืองใหญ่ที่เคยรุ่งเรืองแห่งนี้", "rifle": "ปืนยาว", "sulphur": "กำมะถัน", "steel": "เหล็กกล้า",
 ...
 "a convoy lurches in, equal parts worry and hope.": "ผู้คุ้มกันกระโจนเข้ามาอย่างกล้า ๆ กลัว ๆ", "the map uncovers a bit of the world": "แผนที่เปิดเผยบางส่วนของดินแดน",
 ...
 "a shack stands at the center of the village.": "มีเพิงไม้ตั้งอยู่กลางหมู่บ้าน",
 ...
 "smoldering": "คุกกรุ่น", "the young settler was carrying a canvas sack.": "ผู้ตั้งรกรากหอบถุงผ้าใบมาด้วย",
 "the ground is littered with small teeth": "บนพื้นมีเขี้ยวเล็ก ๆ กระจัดกระจายเต็มไปหมด", "the nest of a large animal lies at the back of the cave.": "ที่สุดปลายถ้ำมีรังของสัตว์ขนาดใหญ่อยู่", "A Tiny Village": "หมู่บ้านเล็ก ๆ ", "a tribe of elderly squatters is camped out in this ward.": "ชนเผ่าที่มีแต่คนชราปักหลักอาศัยอยู่ในหอผู้ป่วยแห่งนี้", "your are connected to dropbox with account / email ": "คุณเชื่อมต่อกับ dropbox", "Mesosphere": "Mesosphere",
  ...
  "a crudely made charm": "เครื่องรางที่แกะสลักอย่างหยาบ ๆ ", "cask": "กระติกน้ำ", "engine:": "เครื่องยนต์",
  ...
  "unarmed master": "ปรมาจารย์หมัดเปล่า", "the man says he's grateful. says he won't come around any more.": "ชายผู้นั้นขอบคุณ และกล่าวว่าเขาจะไม่มารบกวนอีก",
   ...
   "the compass points southwest": "เข็มทิศชี้ไปทางตะวันตกเฉียงใต้", "the wanderer leaves, cart loaded with wood": "ผู้เดินทางจากได้พร้อมกับรถเข็นที่จุไปด้วยไม้",
    "Dropbox Export / Import": "Dropbox Export / Import", "maybe some useful stuff in the rubble.": "อาจจะมีของมีประโยชน์ติดอยู่หลังซากปรักหักพัง",
	 "google+": "google+", "ok": "ตกลง", "a man hobbles up, coughing.": "ชายคนหนึ่งกระเพลกเข้ามา ไอเสียงดัง", "i armour": "เกราะเหล็ก",
	 ...
	 "load from slot": "load จากช่อง", "energy cell": "แผงพลังงาน", "inside the hut, a child cries.": "มีเสียงเด็กร้องไห้ในกระท่อม",
...
"tattered cloth": "ผ้าขาด ๆ ", "can't read the words.": "ไม่สามารถอ่านได้", "tanner": "คนฟอกหนัง",
"should cure the meat, or it'll spoil. builder says she can fix something up.": "น่าจะตากเนื้อเอาไว้บ้าง ไม่เช่นนั้นมันจะเน่าไป",
"or migrating computers": "หรือย้ายเครื่อง", "water:{0}": "น้ำ:{0}", "still time to rescue a few supplies.": "ยังมีเวลาเก็บของเล็กน้อย",
